/* i18n —— 界面文案多语言（英文 / 简体中文 / 繁中（台灣）/ 繁中（香港），详见 i18n.c）。
 * 语言偏好存 Config.lang（0=跟随系统 1=English 2=简体 3=繁中（台灣）4=繁中（香港））；
 * 运行时当前语言由 i18n_init 解析（偏好 AUTO 时用 SceAppUtil 读系统语言，
 * 系统简/繁中文分别映射到简体 / 繁中（台灣）——系统只区分简繁、无法再分台港，
 * 而 PSV 的中文（繁體）本地化基底是台灣用語，故繁体默认取台灣；港式用词可在
 * 设置页语言行手选「繁中（香港）」；其余语言暂回退英文）。
...
/* 当前实际语言：I18N_LANG_EN / I18N_LANG_ZH / I18N_LANG_ZH_TW / I18N_LANG_ZH_HK
 * （渲染前查一次即可） */
int i18n_lang(void);
...
/* 语言选项显示名（AUTO/EN/简/繁台/繁港，各自语种自述） */
